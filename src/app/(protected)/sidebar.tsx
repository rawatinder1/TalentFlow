...
export function AppSidebar() {
  ...
  const router = useRouter(); // ✅ works in /app
    ...
    >
      ...
      <div className="flex items-center p-6 border-b border-zinc-700/50">
        ...
        >
          ...
          <motion.span
            className="font-extrabold text-xl bg-gradient-to-r from-yellow-400 via-red-400 to-blue-400 bg-clip-text text-transparent"
